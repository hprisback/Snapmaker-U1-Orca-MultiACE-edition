...
static wxIcon main_frame_icon(GUI_App::EAppMode app_mode)
{
    ...
    return wxIcon((boost::format("%1%/images/OrcaSlicer.ico") % resources_dir()).str(), wxBITMAP_TYPE_ICO);
#else // _WIN32
    ...
    m_main_frame(mainframe)
{
...
#if _WIN32
    {
        ...
        SetIcon(wxIcon((boost::format("%1%/images/OrcaSlicer.ico") % resources_dir()).str(), wxBITMAP_TYPE_ICO));
    }
#else
